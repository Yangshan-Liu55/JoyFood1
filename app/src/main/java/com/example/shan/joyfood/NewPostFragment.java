...
public class NewPostFragment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        editText_text = (EditText)view.findViewById(R.id.editText_text);
        editText_ingredient = (EditText)view.findViewById(R.id.editText_ingredient);
        editText_direction = (EditText)view.findViewById(R.id.editText_direction);

        btn_chooseImg = (ImageButton) view.findViewById(R.id.btn_chooseImg);
        btn_addPost = (Button) view.findViewById(R.id.btn_addPost);
        btn_go_Login = (Button) view.findViewById(R.id.btn_go_Login);
    ...
    private void uploadImg(String postName) {
        ...
        if (filePath != null && imgChosen) {
            ...
            String defaulImageUrl = "https://firebasestorage.googleapis.com/v0/b/joyfood-database.appspot.com/o/images%2Flogo.jpeg?alt=media&token=ec529896-79c2-4727-adbb-881e62188f74";
