...
public class LoginFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        toLogin = (Button) view.findViewById(R.id.btn_setting_to_login);
        signOut = (Button) view.findViewById(R.id.sign_out);
        Button btnFinishAllAct = (Button) view.findViewById(R.id.btn_finish_all_acts);
//        Button btnForceOffline = (Button) view.findViewById(R.id.btn_force_off_line);
        ...
        img_logo_view = (ImageView)view.findViewById(R.id.img_logo_view);
...
//            @Override
//            public void onClick(View v) {
//                Intent i = new Intent("com.example.shan.joyfood.FORCE_OFFLINE");
