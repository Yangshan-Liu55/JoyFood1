...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.liu55.shan.joyfood.R.layout.activity_main);
    ...
    private void initView() {
        viewPager = (ViewPager)findViewById(com.liu55.shan.joyfood.R.id.view_pager);
        navigation = (BottomNavigationView) findViewById(com.liu55.shan.joyfood.R.id.navigation);//can declare in onCreate
        ...
        navigation.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()) {
                    case com.liu55.shan.joyfood.R.id.navigation_home:
...
//                        stackFragment.push(0);
                        ...
                        return true;
                    case com.liu55.shan.joyfood.R.id.navigation_add:
                        viewPager.setCurrentItem(1);
                        if (!stackFragment.lastElement().equals(1)) { stackFragment.push(1);}

                        return true;
                    case com.liu55.shan.joyfood.R.id.navigation_setting:
