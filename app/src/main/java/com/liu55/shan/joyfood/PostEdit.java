...
public class PostEdit extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.liu55.shan.joyfood.R.layout.activity_post_edit);
        ...
        //initial view
        editText_name = (EditText)findViewById(com.liu55.shan.joyfood.R.id.edit_name);
        TextView textView_user = (TextView)findViewById(com.liu55.shan.joyfood.R.id.textView_post_user);
        TextView textView_time = (TextView)findViewById(com.liu55.shan.joyfood.R.id.textView_post_time);
        image_show = (ImageView)findViewById(com.liu55.shan.joyfood.R.id.image_post_show);
        ImageButton btn_chooseImg = (ImageButton)findViewById(com.liu55.shan.joyfood.R.id.imgBtn_chooseImg);
        editText_text = (EditText)findViewById(com.liu55.shan.joyfood.R.id.edit_text);
        editText_ingredient = (EditText)findViewById(com.liu55.shan.joyfood.R.id.edit_ingredient);
        editText_direction = (EditText)findViewById(com.liu55.shan.joyfood.R.id.edit_direction);
        ImageButton btn_delete = (ImageButton)findViewById(com.liu55.shan.joyfood.R.id.imgBtn_Delete);
        Button btn_sendPost = (Button)findViewById(com.liu55.shan.joyfood.R.id.btn_sendPost);
